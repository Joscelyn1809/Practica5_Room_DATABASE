...
import com.example.practica5_room.ui.Utils
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        LazyColumn {
            ...
            items(homeState.countries) {
                CountryItems(country = it) {
                    onNavigate.invoke(it.country.countryId)
                }
            }
        }
    }
    ...
    Card(modifier = Modifier
        ...
        Row(
            ...
            Column(modifier = Modifier.padding(10.dp)) {
                Text(text = country.country.countryName)
                Spacer(modifier = Modifier.size(4.dp))
                Text(text = country.country.continent)
            }
        }
    }
}
